    ...
    const jobsData = [
      {
        ...
        vacancies: 3,
        qualification: 'Master’s Degree in Education / Mathematics (B.Ed / M.Ed)',
        skills: ['Curriculum Planning', 'STEM Education', 'Classroom Management', 'Board Exam Preparation'],
        description: 'We are seeking an experienced Senior High School Mathematics Teacher for a prestigious private academy in Trichy. The ideal candidate will inspire students through advanced calculus, algebra, and analytical thinking.',
        responsibilities: [
          'Design and deliver engaging daily lesson plans aligning with state and CBSE academic standards.',
          'Prepare students for board examinations and competitive entrance tests.',
          'Maintain regular communication with parents regarding student progress.'
        ],
        benefits: ['Full Health Insurance', 'Provident Fund (PF)', 'Tuition Assistance for Children', 'Paid Summer Leave'],
        genderPreference: 'Any',
        ageLimit: '24 - 55 Years',
        workingHours: '8:30 AM - 4:30 PM (Mon-Fri)',
        status: 'published',
        isFeatured: true,
      ...
      },
      {
        ...
        vacancies: 2,
        qualification: 'Security Officer Certification / Ex-Servicemen Preferred',
        skills: ['Access Control', 'CCTV Operations', 'Emergency Response', 'Team Leadership'],
        description: 'Apex Security requires a Lead Security Supervisor to oversee safety protocols, visitor management, and guard patrols at a premier corporate tech park in Chennai.',
        responsibilities: [
        ...
        benefits: ['Overtime Allowance', 'Uniform Provided', 'ESI & Medical Coverage', 'Performance Bonuses'],
        genderPreference: 'Any',
      ...
      },
      {
        ...
        vacancies: 5,
        qualification: 'B.Sc Nursing / GNM + BLS / ACLS Certification',
        skills: ['Patient Monitoring', 'Ventilator Management', 'EMR Systems', 'Critical Care Nursing'],
        description: 'Join a premier multi-speciality hospital in Coimbatore as a Critical Care ICU Nurse providing life-saving interventions and compassionate bedside care.',
        responsibilities: [
        ...
        benefits: ['Joining Bonus', 'Hostel Accommodation Available', 'Comprehensive Medical & ESI', 'Continuing Education Stipend'],
        genderPreference: 'Any',
        ageLimit: '22 - 50 Years',
        workingHours: '8-12 Hours (Rotational Shifts)',
        status: 'published',
        isFeatured: true,
        companyName: 'Metropolitan Super Speciality Hospital',
      ...
      },
      {
        ...
        vacancies: 4,
        qualification: 'Certified Nursing Assistant (CNA) / ANM or Experienced Caretaker',
        skills: ['Elder Care', 'Mobility Assistance', 'Medication Reminders', 'Meal Prep'],
        description: 'Seeking a warm, patient Home Care Aide in Madurai to assist an elderly client with daily living activities, companionship, and medication reminders.',
        responsibilities: [
        ...
        benefits: ['Live-in Room & Board Option', 'Paid Leave', 'Festive Bonus'],
        genderPreference: 'Female',
        ageLimit: '25 - 55 Years',
        workingHours: 'Full-Time Live-in or 8-Hour Shift',
        status: 'published',
        isFeatured: false,
        companyName: 'Jessy Healthcare At Home',
      ...
      },
      {
        ...
        vacancies: 1,
        qualification: 'MBA in Human Resources / MSW',
        skills: ['Talent Acquisition', 'Employee Relations', 'Statutory Compliance', 'Performance Management'],
        description: 'An executive role leading HR strategy, organizational development, employee engagement, and talent acquisition for a large manufacturing and retail group in Salem.',
        responsibilities: [
          'Partner with senior management to align people strategies with business goals.',
        ...
        benefits: ['PF & Gratuity', 'Annual Performance Bonus', 'Comprehensive Health Insurance'],
        genderPreference: 'Any',
      ...
      },
      {
        ...
        vacancies: 2,
        qualification: 'B.Com / M.Com / Inter CA or MBA Finance',
        skills: ['Tally Prime / ERP Payroll', 'PF / ESI / TDS Filing', 'Audit Compliance', 'Excel Advanced'],
        description: 'Responsible for managing bi-weekly payroll execution, statutory tax compliance, PF/ESI filing, and accounts reconciliation.',
        responsibilities: [
          'Execute automated payroll processing via ERP payroll software.',
        ...
        benefits: ['PF + ESI Coverage', 'Annual Bonus', 'Medical Insurance', 'Career Escalation'],
        genderPreference: 'Any',
