...
const settingsSchema = new mongoose.Schema(
  {
    siteName: { type: String, default: 'Apex Global Staffing & HR Solutions' },
    tagline: { type: String, default: 'Empowering Enterprises with World-Class Talent' },
    contactEmail: { type: String, default: 'info@apexstaffing.com' },
    contactPhone: { type: String, default: '+1 (800) 555-APEX' },
    ...
    metaTitle: { type: String, default: 'Apex HR - Premium Staffing & HR Solutions' },
